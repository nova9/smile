...
<x-volunteer.dashboard-layout>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-3">
                    <button
                        class="px-4 py-2 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl text-slate-600 hover:bg-white hover:shadow-md transition-all duration-200">
                        <i data-lucide="calendar" class="w-4 h-4 mr-2"></i>
                        Calendar View
                    </button>
                    <button
                        class="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
            <div
                class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 p-6 hover:shadow-lg hover:bg-white transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-violet-100 to-violet-200 rounded-xl flex items-center justify-center">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 p-6 mb-8">
            <div class="flex flex-wrap gap-4 items-center">
                ...
                <div class="flex flex-wrap gap-3 flex-1">
                    <select
                        class="px-4 py-2.5 border border-slate-200 rounded-xl text-sm bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200">
                ...
                <button
                    class="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-sm transition-all duration-200">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-2">
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-1 border border-slate-200">
                        <button
                            class="px-3 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg text-sm font-medium transition-all duration-200">
                            <i data-lucide="list" class="w-4 h-4 mr-1"></i>
                            List
                        </button>
                        <button
                            class="px-3 py-1.5 text-slate-600 rounded-lg text-sm font-medium hover:bg-slate-100 transition-all duration-200">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select
                        class="px-3 py-1.5 border border-slate-200 rounded-lg text-sm bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200">
        ...
        <!-- Events List (Desktop) -->
        <div
            class="hidden md:block bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 overflow-hidden">
            <!-- Table Header -->
                ...
                @foreach($myEvents as $event)
                    <div class="px-6 py-5 hover:bg-white/60 transition-all duration-200 group">
                        <div class="grid grid-cols-12 gap-4 items-center">
                            ...
                            <div class="col-span-4">
                                <div class="flex items-start gap-4">
                                    <div class="relative">
                                        ...
                                        @endphp
                                        <div
                                            class="w-14 h-14 rounded-2xl bg-gradient-to-br {{ $gradientClass }} flex-shrink-0 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <h3
                                            class="font-bold text-slate-900 mb-2 text-lg group-hover:text-blue-600 transition-colors duration-200">
                                            {{ $event['name'] }}</h3>
                                        ...
                                        <div class="flex items-center gap-3 text-xs">
                                            ...
                                            @endphp
                                            <span
                                                class="px-3 py-1.5 bg-gradient-to-r {{ $badgeClass }} rounded-full font-medium">{{ $event['category'] }}</span>
                            ...
                            <div class="col-span-2">
                                <div
                                    class="flex items-center gap-2 text-sm text-slate-600 bg-white/50 rounded-xl p-3 border border-slate-100">
                                    <div
                            ...
                            <div class="col-span-1">
                                <div class="flex items-center gap-2">
                                    @if($event['status'] === 'pending')
                                        <button
                                            class="group relative p-2.5 text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                            title="Cancel">
                                            <i data-lucide="x" class="w-4 h-4"></i>
                                            <div
                                                class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-gray-900 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                                                Cancel</div>
                                        </button>
                                        <button
                                            class="group relative p-2.5 text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                            title="Message">
                                    ...
                                    @elseif($event['status'] === 'confirmed')
                                        ...
                                        <button
                                            class="group relative p-2.5 text-green-600 bg-green-50 hover:bg-green-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                            title="Message">
                                            <i data-lucide="message-circle" class="w-4 h-4"></i>
                                            <div
                                                class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-gray-900 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                                    ...
                                    @elseif($event['status'] === 'completed')
                                        <button
                                            class="group relative p-2.5 text-amber-600 bg-amber-50 hover:bg-amber-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                            title="Rate Event">
                                        ...
                                        <button
                                            class="group relative p-2.5 text-violet-600 bg-violet-50 hover:bg-violet-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                    ...
                                    @else
                                        <button
                                            class="group relative p-2.5 text-slate-400 bg-slate-50 hover:bg-slate-100 rounded-xl transition-all duration-200 hover:shadow-lg"
                                            title="View Details">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 overflow-hidden">
                    ...
                    <div class="p-5 border-b border-slate-100">
                        <div class="flex items-start gap-4">
                            ...
                            @endphp
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br {{ $gradientClass }} flex items-center justify-center shadow-lg">
                                @if($event['category'] === 'Environment')
                            ...
                            @if($event['status'] === 'confirmed')
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-emerald-100 text-emerald-700">
                                    <div class="w-1.5 h-1.5 bg-emerald-500 rounded-full mr-1"></div>
                                    Confirmed
                                </span>
                            @elseif($event['status'] === 'pending')
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-amber-100 text-amber-700">
                                    <div class="w-1.5 h-1.5 bg-amber-500 rounded-full mr-1"></div>
                                    Pending
                                </span>
                            @elseif($event['status'] === 'completed')
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-violet-100 text-violet-700">
                                    <i data-lucide="check-circle" class="w-3 h-3 mr-1"></i>
                                    Completed
                                </span>
                            @elseif($event['status'] === 'cancelled')
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-rose-100 text-rose-700">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <div>
                                    <div class="font-medium text-slate-900">{{ date('M j, Y', strtotime($event['date'])) }}
                                    </div>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-4">
                                ...
                                @endphp
                                <span
                                    class="px-2 py-1 bg-gradient-to-r {{ $badgeClass }} rounded-lg font-medium">{{ $event['category'] }}</span>
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-sm font-bold text-white">
                                {{ substr($event['organizer'], 0, 1) }}
                            </div>
                            <div>
                    ...
                    <div class="px-5 py-4 bg-slate-50/50 border-t border-slate-100">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                @if($event['status'] === 'pending')
                                    <button
                                        class="p-2 text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="x" class="w-4 h-4"></i>
                                    </button>
                                    <button
                                        class="p-2 text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="message-circle" class="w-4 h-4"></i>
                                    </button>
                                @elseif($event['status'] === 'confirmed')
                                    <button
                                    ...
                                    <button
                                        class="p-2 text-green-600 bg-green-50 hover:bg-green-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="message-circle" class="w-4 h-4"></i>
                                    </button>
                                @elseif($event['status'] === 'completed')
                                    <button
                                        class="p-2 text-amber-600 bg-amber-50 hover:bg-amber-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="star" class="w-4 h-4"></i>
                                    </button>
                                    <button
                                        class="p-2 text-violet-600 bg-violet-50 hover:bg-violet-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="download" class="w-4 h-4"></i>
                                    </button>
                                @else
                                    <button
                                        class="p-2 text-slate-400 bg-slate-50 hover:bg-slate-100 rounded-lg transition-all duration-200">
                                        <i data-lucide="eye" class="w-4 h-4"></i>
                                    </button>
                                @endif
                            </div>
        ...
        <div
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    <button
                        class="w-10 h-10 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-sm font-semibold shadow-lg">1</button>
                    <button
        ...
        <div class="fixed bottom-6 right-6 flex flex-col gap-3 z-10">
            <button
                class="group w-14 h-14 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center">

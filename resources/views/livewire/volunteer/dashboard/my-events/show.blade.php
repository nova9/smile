                ...
                <div class="flex-1 p-8 flex flex-col justify-between">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 text-center">
                            ...
                            <div class="font-semibold text-gray-700"> {{$event->starts_at->diffForHumans($event->ends_at)}}</div>
                        </div>
                        <div class="bg-gray-50 rounded-xl p-4 text-center">
                        ...
                        <div class="lg:col-span-3 space-y-8">
                            ...
                            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-xl p-6">
                                ...
                                <p class="text-gray-600 text-sm mb-4">
                                    Passionate about building a cleaner, greener community. Organized 20+ local events and mobilized hundreds of volunteers.
                                </p>
                                <div class="space-y-2">
...
{{--                                    get status from event_user table--}}
                                ...
                                @if($event->ends_at > now() && $status == 'accepted')
                                    <div class="flex flex-col md:flex-row gap-3">
                                        ...
                                        <button class="w-full md:w-auto btn btn-accent flex-1 inline-flex items-center justify-center gap-2 font-semibold shadow hover:bg-primary transition-colors duration-200">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                                            </svg>
                                            <a href="{{ route('community.space') }}" class="text-white">Go to Community Space</a>
                                        </button>
                                        <button class="w-full md:w-auto btn btn-outline flex-1">

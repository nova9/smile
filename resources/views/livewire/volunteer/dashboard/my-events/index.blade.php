    ...
    <div class="min-h-screen p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-3xl font-bold text-violet-600">{{ count($completedEvents) }}</div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-3xl font-bold text-rose-600">{{ count($cancelledEvents) }}</div>
                ...
                @foreach ($participatingEvents as $item)
                    <div class="px-6 py-5 hover:bg-white/60 transition-all duration-200 group">
                        <div class="grid grid-cols-12 gap-4 items-center">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <a href="/volunteer/dashboard/my-events/{{ $item->id }}"
                                            class="font-bold text-slate-900 mb-2 text-lg group-hover:text-blue-600 transition-colors duration-200 hover:underline">
                                            {{ $item->name }}
                                        </a>
                                        <p class="text-sm text-slate-600 line-clamp-2 mb-3">{{ $item->description }}
                                        </p>
                                        <div class="flex items-center gap-3 text-xs">
                                            ...
                                            @endphp
                                            <span
                                                class="px-3 py-1.5 bg-gradient-to-r {{ $badgeClass }} rounded-full font-medium"></span>
                            ...
                            <div class="col-span-2">
                                <div
                                    class="flex items-center gap-3 bg-white/50 rounded-xl p-3 border border-slate-100">
                                    <div class="relative">
                                        <div
                    ...
                    <div class="p-5 border-b border-slate-100">
                        <div class="flex items-start gap-4">
                            @php
                                ...
                                $gradientClass =
                                    $categoryColors[$item->category->id ?? null] ?? 'from-slate-400 to-slate-600';
                            @endphp
                            <div
                            ...
                            <div class="flex-1 min-w-0">
                                <a href="/volunteer/dashboard/events/{{ $item->id }}"
                                    class="font-bold text-slate-900 text-lg mb-1 hover:underline block">
                                    {{ $item->name }}
                                </a>
                            ...
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <div>
                                    <div class="font-medium text-slate-900">
                                        {{ $item->starts_at ? $item->starts_at->format('M j, Y') : '' }}</div>
                                    <div class="text-slate-500">
                                        {{ $item->starts_at ? $item->starts_at->format('h:i A') : '' }}</div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2 text-sm">
                                <i data-lucide="map-pin" class="w-4 h-4 text-slate-500"></i>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-4">
                                @php
                                    ...
                                    $badgeClass =
                                        $badgeColors[$item->category->id ?? null] ??
                                        'from-slate-100 to-slate-200 text-slate-700';
                                @endphp
                                <span
                                    class="px-2 py-1 bg-gradient-to-r {{ $badgeClass }} rounded-lg font-medium">{{ $item->category->name ?? '' }}</span>

    ...
    <main class="relative z-10 px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="text-center space-y-6">
                <div class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500/10 to-purple-600/10 text-black rounded-full text-sm font-medium shadow-lg backdrop-blur-sm border border-purple-500/20">
                    <i data-lucide="archive" class="w-5 h-5 mr-2 text-purple-600"></i>
                    Contract Archive
                </div>
                <div class="space-y-4">

...
<section
    ...
    <div class="relative container mx-auto px-6 lg:px-8">
        ...
        <div class="text-center mb-16 lg:mb-24">
            <div
                class="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full text-sm font-medium mb-6">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-20 items-center">
                <div class="relative group order-2 lg:order-1">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-accent/20 to-secondary/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-105">
                    </div>
                ...
                <div class="order-1 lg:order-2 space-y-6 lg:pl-8">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-3xl lg:text-4xl font-bold text-accent">Join an Upcoming Event</h3>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3 mt-6">
                        <span class="px-4 py-2 bg-accent/10 text-accent rounded-full text-sm font-medium">Community
                            Workshops</span>
                        <span
                            class="px-4 py-2 bg-secondary/10 text-secondary rounded-full text-sm font-medium">Volunteer
                            Drives</span>
                        <span class="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium">Networking
                            Events</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-20 items-center">
                <div class="space-y-6 lg:pr-8">
                    ...
                    <div
                        class="bg-gradient-to-r from-secondary/5 to-accent/5 p-6 rounded-xl border border-secondary/20">
                ...
                <div class="relative group">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-secondary/20 to-primary/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-105">
                    </div>
                    <div class="relative overflow-hidden rounded-2xl shadow-2xl">
            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 items-center">
                <div class="relative group order-2 lg:order-1">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-primary/20 to-accent/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-105">
                    </div>
                    <div class="relative overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div class="order-1 lg:order-2 space-y-6 lg:pl-8">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-3xl lg:text-4xl font-bold text-primary">Spread the Word</h3>
                    </div>
        ...
        <div class="text-center">
            ...
            <div class="inline-flex items-center gap-4 p-2 bg-white rounded-full shadow-xl border border-gray-100">
                <x-common.landing.buttons.button2
                    class="bg-accent text-white border-accent hover:bg-accent/90 shadow-lg">
                ...
                <button
                    class="text-gray-600 hover:text-accent transition-colors duration-300 px-6 py-3 rounded-full hover:bg-gray-50">
                    Learn More

    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Discover the heart and soul behind our volunteer community. We're more than just an organization –
                we're a family of changemakers dedicated to spreading kindness worldwide.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div
                class="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <div
                    class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-t-2xl">
                </div>
                <div class="mb-6">
                    <div
                        class="w-16 h-16 bg-yellow-500/10 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                class="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <div
                    class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-500 to-pink-600 rounded-t-2xl">
                </div>
                <div class="mb-6">
                    <div
                        class="w-16 h-16 bg-purple-500/10 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
